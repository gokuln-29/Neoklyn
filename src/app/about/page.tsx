        ...
        <PageWrapper>
            <section className="section" style={{ position: 'relative', overflow: 'hidden' }}>
                ...
                <div style={{ position: 'absolute', inset: 0, zIndex: 0, opacity: 0.3, pointerEvents: 'none' }}>
                    ...
                    <div style={{ width: '3px', height: '3px', background: 'var(--pink)', borderRadius: '50%', position: 'absolute', top: '70%', left: '30%', boxShadow: '0 0 10px var(--pink)', animation: 'float 8s ease-in-out infinite reverse' }}></div>
                    <div style={{ width: '5px', height: '5px', background: 'var(--amber)', borderRadius: '50%', position: 'absolute', top: '40%', right: '20%', boxShadow: '0 0 10px var(--amber)', animation: 'float 5s ease-in-out infinite' }}></div>
                ...
                <div className="reveal" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', marginTop: '6rem', position: 'relative', zIndex: 1 }}>
                    ...
                    <div style={{ padding: '3rem', background: 'var(--ink)', border: '1px solid var(--border)', borderRadius: '16px' }}>
                        <h3 className="p-title" style={{ fontSize: '1.8rem', marginBottom: '1rem', color: 'var(--pink)' }}>Global Talent</h3>
            ...
            <section className="section section-alt">
                ...
                <div className="reveal" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1px', background: 'var(--border)', border: '1px solid var(--border)', borderRadius: '16px', overflow: 'hidden', marginTop: '4rem' }}>
                    <div style={{ background: 'var(--bg)', padding: '3rem' }}>
                        <div className="m-num" style={{ color: 'rgba(0,255,224,0.05)', fontSize: '4rem', marginBottom: '1rem' }}>01</div>
                    ...
                    <div style={{ background: 'var(--bg)', padding: '3rem' }}>
                        <div className="m-num" style={{ color: 'rgba(0,255,224,0.05)', fontSize: '4rem', marginBottom: '1rem' }}>02</div>
                    ...
                    <div style={{ background: 'var(--bg)', padding: '3rem' }}>
                        <div className="m-num" style={{ color: 'rgba(0,255,224,0.05)', fontSize: '4rem', marginBottom: '1rem' }}>03</div>
